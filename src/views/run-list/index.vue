...
export default {
  ...
  methods: {
    ...
    handleCourseRun(courseId, runId) {
      console.log('跳转detail中,课程id:', courseId + 'runId:', runId + '用户名' + this.username)
      this.$router.push({ path: '/courseResult/index', query: { courseId: courseId, runId: runId, username: this.username }})
    }
  }
}
</script>
